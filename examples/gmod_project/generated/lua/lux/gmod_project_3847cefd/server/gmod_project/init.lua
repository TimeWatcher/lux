return function(__lux_import)
  --#lux source: C:\Development\gmod\lux\examples\gmod_project\src\server\init.lux:1
  local __lux_exports = {}
  --#lux source: C:\Development\gmod\lux\examples\gmod_project\src\server\init.lux:12
  local announce
  --#lux source: C:\Development\gmod\lux\examples\gmod_project\src\server\init.lux:1
  do
    local __lux_import_1 = __lux_import("gmod_project/hud#server")
    local buildHud = __lux_import_1.buildHud
  --#lux source: C:\Development\gmod\lux\examples\gmod_project\src\server\init.lux:2
    local __lux_import_2 = __lux_import("lux/gmod#server")
    local netx = __lux_import_2.netx
  --#lux source: C:\Development\gmod\lux\examples\gmod_project\src\server\init.lux:5
    netx.register("lux:announce_hud")
  --#lux source: C:\Development\gmod\lux\examples\gmod_project\src\server\init.lux:7
    do
